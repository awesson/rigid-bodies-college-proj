...
public:
     ...
     */
    Matrix3( const Vec3& u, const Vec3& v, const Vec3& w );
...
void make_transformation_matrix(
    Matrix4* rv, const Vec3& pos, const Quaternion& ori, const Vec3& scl );
